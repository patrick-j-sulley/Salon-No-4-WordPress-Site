...
<head>
  ...
  <link rel="profile" href="<?php echo esc_url( __( 'http://gmpg.org/xfn/11', 'vw-hair-salon' ) ); ?>">
  <?php wp_head(); ?>
</head>
...
<body <?php body_class(); ?>>
	...
	<?php if(get_theme_mod('vw_hair_salon_loader_enable',true)==1){ ?>
	  	<div id="preloader">
	    	<div id="status">
		      <?php $theme_lay = get_theme_mod( 'vw_hair_salon_loader_icon','Two Way');
