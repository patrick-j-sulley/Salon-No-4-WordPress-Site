...
function vw_hair_salon_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-hair-salon' ) .'</h3>';
...
function vw_hair_salon_scripts() {
	...
	wp_enqueue_style( 'vw-hair-salon-effect', get_template_directory_uri().'/css/effect.css' );
	wp_enqueue_style( 'font-awesome', get_template_directory_uri().'/css/fontawesome-all.css' );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.js', array('jquery') ,'',true);
	wp_enqueue_script( 'jquery-superfish', get_template_directory_uri() . '/js/jquery.superfish.js', array('jquery') ,'',true);
	wp_enqueue_script( 'vw-hair-salon-custom-scripts-jquery', get_template_directory_uri() . '/js/custom.js', array('jquery') );
...
function vw_hair_salon_ie_stylesheet(){
	wp_enqueue_style('vw-hair-salon-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-hair-salon-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_hair_salon_ie_stylesheet');
...
define('VW_HAIR_SALON_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-hair-salon/','vw-hair-salon');
define('VW_HAIR_SALON_SUPPORT','https://wordpress.org/support/theme/vw-hair-salon/','vw-hair-salon');
define('VW_HAIR_SALON_REVIEW','https://wordpress.org/support/theme/vw-hair-salon/reviews/','vw-hair-salon');
define('VW_HAIR_SALON_BUY_NOW','https://www.vwthemes.com/themes/hair-salon-wordpress-theme/','vw-hair-salon');
define('VW_HAIR_SALON_LIVE_DEMO','https://vwthemes.net/hair-salon-pro/','vw-hair-salon');
define('VW_HAIR_SALON_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-hair-salon-pro/','vw-hair-salon');
define('VW_HAIR_SALON_FAQ','https://www.vwthemes.com/faqs/','vw-hair-salon');
define('VW_HAIR_SALON_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-hair-salon');
define('VW_HAIR_SALON_CONTACT','https://www.vwthemes.com/contact/','vw-hair-salon');
define('VW_HAIR_SALON_CREDIT','https://www.vwthemes.com/themes/free-hair-salon-wordpress-theme/','vw-hair-salon');

if ( ! function_exists( 'vw_hair_salon_credit' ) ) {
	function vw_hair_salon_credit(){
		echo "<a href=".esc_url(VW_HAIR_SALON_CREDIT).">".esc_html__('Hair Salon WordPress Theme','vw-hair-salon')."</a>";
	}
}
