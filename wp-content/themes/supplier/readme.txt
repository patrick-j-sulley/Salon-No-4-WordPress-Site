...
Supplier is distributed under the terms of the GNU GPL
Supplier -Copyright 2018 Supplier, themeicy.com
...
SHORT DESCRIPTION
=================
Supplier is a powerful bootstrap Wordpress theme for spa or individuals. Supplier theme which can be used for web design firms or any other transport, supplier, woocommerce and any other kind of website purpose. It comes with all features these kind of shop page, blog page, Contact form seven working, custom logo, slides variation, color pallate
...
Supplier WordPress Theme is the child theme of Transportex, Copyright 2017 Themeansar
Supplier is distributed under the terms of the GNU General Public License v2 

/***** BUNDELED CSS ***/
============================================
This theme uses Underscores
============================================
 * Supplier is based on Underscores. All the files in the theme package are from Underscores, unless stated otherwise.
...
1. https://www.pexels.com/photo/photography-of-ship-799091/
